...
import './DialogTrabajador.css';
const DialogTrabajador = ({ visible, onHide,genders,typeDocuments,formik,jobs }) => {
    const header=(
        <>
    ...
    return (
        ...
        <Dialog header={header} visible={visible} onHide={() => onHide()} className='dialog' style={{ width: '50%' }} breakpoints={{ '960px': '75vw', '641px': '100vw' }}>
            <form onSubmit={formik.handleSubmit}>
                <div className="formgrid grid ">
                    <div className="field col-12 lg:col-6 md:col-6 sm:col-12 py-0">
                ...
                <div className="formgrid grid py-0">
                    ...
                    <div className="field lg:col-6 md:col-6 sm:col-12 py-0 col-12">
                        <label htmlFor="job" className="block font-medium text-900 text-sm">Cargo</label>
                        <span className="p-input-icon-right w-full">
                        {/* <Dropdown 
                            className={`
                                w-full p-inputtext-sm border-1 
                                ${formik.touched.job && !formik.errors.job && 'border-green-500'} 
                        ...
                        {formik.touched.job && formik.errors.job && <small id="username-help" className="text-red-500 text-xs">{formik.errors.job}</small>}
...
export default DialogTrabajador